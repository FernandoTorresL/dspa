<?php
    ...
    if ( isset( $_POST['submit'] ) ) {
      ...
      // Obtener todas las solicitudes según usuario con LIKE
        $query = 'SELECT DISTINCT
          ...
          $query = $query . " ORDER BY L.id_lote DESC, S.usuario ;";

         
        /*echo( $query );*/
$data = mysqli_query($dbc, $query);
          echo '<p class="mensaje">Solicitudes localizadas para el usuario ' . $usuario . '</p>';
