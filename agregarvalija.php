<?php
    ...
    $ResultadoConexion = fnConnectBD( $_SESSION['id_user'],  $_SESSION['ip_address'], 'EQUIPO.' . $_SESSION['host'], 'Conn-AgregarValija' );
    ...
    if ( mysqli_num_rows( $data ) == 1 ) {
      ...
      require_once('lib/footer.php');
      $log = fnGuardaBitacora( 5, 102, $_SESSION['id_user'],  $_SESSION['ip_address'], 'CURP:' . $_SESSION['username'] . '|EQUIPO:' . $_SESSION['host'] );
      exit(); 
    }
                  ...
                  if ( $_FILES['new_file']['error'] == 0 ) {
                    ...
                    if ( move_uploaded_file( $_FILES['new_file']['tmp_name'], $target ) ) {
                      ...
                      $query = "INSERT INTO ctas_valijas 
                        ...
                        id_remitente, delegacion, comentario, archivo, id_user)
                        VALUES 
                        ( '$num_oficio_ca', '$num_oficio_del', 
                      ...
                      if ( mysqli_num_rows( $data ) == 1 ) {
                        ...
                        $log = fnGuardaBitacora( 1, 102, $_SESSION['id_user'],  $_SESSION['ip_address'], 'id_valija:' . $id_valija_bitacora . '|CURP:' . $_SESSION['username'] . '|EQUIPO:' . $_SESSION['host'] );

                        echo '<p class="mensaje"><strong>¡La nueva valija ha sido creada correctamente!</strong></p>';
                        echo '<p class="mensaje">¿Hubo un error? Puedes EDITAR la <a href="editarvalija.php?valija_id=' . $row['LAST_INSERT_ID()'] . '">valija</a></p>';
                        echo '<p class="mensaje">Puede agregar una <a href="agregarvalija.php">nueva valija</a></p>';
                      ...
                      <?php
                        ...
                        echo '<p class="error"><strong>La nueva valija no ha podido generarse. Contactar al administrador.</strong></p>';
                      }
        ...
        <div class="contenedor">
          <form method="post" enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            ...
            <ul>
              ...
              <li class="buttons">
                <input type="submit" name="submit" value="Agregar valija">
